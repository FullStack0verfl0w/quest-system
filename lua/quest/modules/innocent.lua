...
MODULE.Name = "Say 'No' to traitors"
MODULE.Description = "Kill %d Traitors"
MODULE.TargetValue = 5 // This is killed traitors count to finish the quest
MODULE.RewardType = TTTQuests.RewardType.Item // For random just define MODULE.Reward like this: {{type = 0, reward = 5000}, {type = 2, reward = "%item_class%"}}
MODULE.Reward = "10" // Just define it here. It'll be easily edited later
